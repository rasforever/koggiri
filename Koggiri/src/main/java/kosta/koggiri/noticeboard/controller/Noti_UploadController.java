...
import kosta.koggiri.approval.util.ApprovalUploadFileUtils;



@Controller
@RequestMapping("/noticeboard/*")
public class Noti_UploadController {
	private static final Logger logger = LoggerFactory.getLogger(Noti_UploadController.class);
	...
	public String uploadForm(MultipartFile file, Model model) throws Exception {
		...
		return "/noticeboard/uploadResult";
	}
