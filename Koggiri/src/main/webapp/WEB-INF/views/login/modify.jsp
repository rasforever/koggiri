...
<div class="container_wrap" style="background-color: #ffffff;">
	<div id="container">
		...
		<div id="sub_menu_title">
			<h1>
				<img src="/resources/img/s_menu15.png" />
			</h1>
			<div class="sub_top">
				<span><a href="/main">홈</a> <span> &gt; </span> <strong>내
						정보수정</strong></span>
			</div>
		</div>
		...
		<div id="lnb">
			<div class="lnb01">
				...
				<ul>
					...
					<li class="menu02 "><a href="/login/passcheck">내 정보수정</a>
						<ul>
			...
			<form method="post" action="/login/modify" name="form"
				...
				<table>
					...
					<tr>
						<th>비밀번호 확인</th>
						<td style="text-align: left">&nbsp;&nbsp;<input
							type="password" name="passwordcheck" maxlength="50"
							placeholder="비밀번호 확인"></td>
					</tr>
					<tr>
						<th>E-Mail</th>
						<td style="text-align: left">&nbsp;&nbsp;<input type="text"
							name="e_mail1" maxlength="50" value="" placeholder="이메일 아이디">
					...
					<tr>
						<th>핸드폰번호</th>
						<td style="text-align: left">&nbsp;&nbsp;<select id="telno1"
							name="telno1">
						...
						</select>&nbsp;- <input type="input" name="telno2" id="telno2"
							maxlength="4" style="width: 45px"> - <input type="input"
							name="telno3" id="telno3" maxlength="4" style="width: 45px">
						</td>
					</tr>
					<tr>
						<th>주소</th>
						<td style="text-align: left">&nbsp;&nbsp;<input type="button"
							...
							placeholder="주소"> <input type="text" id="addr2"
					...
					<tr>
						<td colspan="2"><input type="submit" value="수정"
							style="width: 100px; height: 40px"> <input type="button"
