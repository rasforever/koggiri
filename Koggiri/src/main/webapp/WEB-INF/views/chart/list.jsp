...
<div id="lnb">
	<div class="lnb01">
		...
		<ul>
                ...
                <li class="menu02 ">
                    <a href="sub_chart.jsp">조직도</a>
                    <ul>
                    	<li class="sub01"><a href="/chart/list?dept_id='MM'">경영진</li>
		                <li class="sub02"><a href="/chart/list?dept_id='PL'">인사팀</li>
		                <li class="sub03"><a href="/chart/list?dept_id='MT'">관리팀</li>
		                <li class="sub04"><a href="/chart/list?dept_id='SN'">솔루션팀</li>
		                <li class="sub05"><a href="/chart/list?dept_id='BS'">영업팀</li>
		                <li class="sub06"><a href="/chart/list?dept_id='MG'">마게팅팀</li>
                    </ul>
                </li>
           </ul>
	</div>
