...
<div class="container_wrap" style="background-color: #eef1f2;">
				...
				<div class="customer_center">
					...
					<div class="customer_info">
						<ul
							...
							<li><a>${empVO.pos_nm } <strong style="font-size: 25px">${empVO.emp_nm}</strong></a></li>
							<br>
   ...
   style="background-color: #eef1f2; width: 100%; height: 100%; margin: 0 auto;"> -->
		...
		<div class="cal_view">
			...
			<ul>
				<li
					style="font-size: 20px; margin-left: 20px; font-weight: bold; padding-left: 15px; padding-bottom: 5px; border-bottom: 2px solid black; width: 300px;">
					<a href="#">오늘 일정</a>
				</li>
			</ul>
			<br> <br>
			<ul>
				...
				<c:forEach items="${list_calendar}" var="h_CalendarVO">
					<li
						style="font-size: 16px; font-weight: bold; padding-left: 25px; vertiacl-align: middle; height: 20px;"><a
						href="/calendar/index"><span
							style="color: red; font-size: 13px;">* &nbsp;&nbsp;</span>
							${h_CalendarVO.title} <%--    <c:if test="${h_NoticeVO.n_date.substring(0,10) == sysdate}">
                     <img
                        src="http://s.nx.com/S2/billing/pcbang/real/homepage/ico/ico_new.gif"
                        alt="새글" />
                     </c:if> --%> </a></li>
