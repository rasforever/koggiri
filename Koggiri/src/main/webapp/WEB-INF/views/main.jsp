 ...
 <h2 class="hidden">본문</h2>
   ...
   <div class="service">
     ...
     <div class="remote_support" style="width: 226px; height: 206px; background: white;" align="center">
      ...
      <input type="submit" class="off_btn" value="" style="margin: 7px;">
      <input type="submit" value="근태확인" style="width: 120px; height: 35px;  border: 0px; background: gray; margin: 7px;">
   </div>
      ...
      <img src="resources/img/notice_t.png" style="margin-bottom:10px">
         <ul>
                    ...
                    <li><a href="/HelpDesk/Notify/Detail?sn=2455">테일즈런너 넥슨PC방 서비스 종료 안내</a><span>2017-05-22</span></li>
                    
                    
                    <li><a href="/HelpDesk/Notify/EventDetail?sn=484">서든어택 PC방 대회 06월 대상 매장</a><span>2017-05-17</span></li>
                    
                    
                    <li><a href="/HelpDesk/Notify/Detail?sn=2454">(완료) 05/09(화) 가상계좌 결제 서비스 오류 안내(수정)</a><span>2017-05-09</span></li>
                    
         </ul>
         <span class="more"><a href="/HelpDesk/Notify"><img src="http://s.nx.com/S2/billing/pcbang/real/homepage/btn/btn_more.gif" alt="더보기" /></a></span>
      </div>
...
<script type="text/javascript">
   ...
   <div class="weather">
       <input type="text" value="날씨 api 가져오기" style="position: relative;
    bottom: 669px;">
    </div>
...
<table class="table_content"   border="0" cellspacing="1" cellpadding="1" bgcolor="#FFFFFF">
<THEAD>
<TR bgcolor="#EEF1F2">
	<TD>
...
for(int index = 1; index <= endDay; index++)
{
	...
	}else if(newLine == 6){ 	color = "#529dbc"; //파랑색
	}else{						color = "BLACK"; };
...
<!--
    $(document).ready(function () {
        ...
        $("#lnb a,.gnb a,.sitemap a,.remote_support a").filter(function () {
            ...
            window.open("https://113366.com/nexonnetworks");
    ...
    $("#imgPrivacyAgreement").click(function () {
        openPopupFocus("/Home/PrivacyAgreement", "PrivacyAgreement", 720, 650, "yes");
